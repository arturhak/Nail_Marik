export const translationAM = {
    ...
    "Men’s hands paraffin therapy": "Տղամարդկանց Ձեռքերի Պարաֆինաթերապիա",
    "Men’s feets paraffin therapy" : "Տղամարդկանց Ոտքերի Պարաֆինաթերապիա",
    "Design": "Դիզայն",
    ...
    "Pedicure + Gel Lac (Luxio)": "Ոտնահարդարում + Գել Լաք (Luxio)",
    "Pedicure + Gel Lac (Rock Nail)": "Ոտնահարդարում + Գել Լաք (Rock Nail)",
