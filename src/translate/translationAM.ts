export const translationAM = {
    ...
    "Men's Pedicure (Without Heel Treatment)": "Տղամարկանց Ոտնահարդարում  (Առանց Կրունկների Մշակման)",
    ...
    "Repair Of One Nail": "Մեկ Եղունգի Վերանորոգում",
    "Padding For One Nail": "Մեկ Եղունգի Լիցք ",
    "GEL REMOVAL": "Գելլաքի Հեռացում",
    "Hand Acupressure (Scrub Cream)": "Ձեռքերի Կետային Մերսում (Սկռաբ-Կրեմ)",
    "Manicure + Simple Nail Polish": "Մատնահարդարում + ՀԱՍԱՐԱԿ լաք",
    "Paraffin Therapy For Hands": "Ձեռքերի Պարաֆինային Թերապիա",
    "Pedicure + Simple Nail Polish": "Ոտնահարդարում + հասարակ լաք ",
    "Classic Pedicure": "Ոտնահարդարում",
    "Pedicure + Gel Polish": "Ոտնահարդարում + Գել Լաք",
