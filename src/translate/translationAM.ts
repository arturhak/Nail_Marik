export const translationAM = {
    ...
    "For Kids": "Մանկական",
    "For Girls": "Աղջիկների",
    "Girl's Haircut": "Աղջկա Կտրվածք",
    "Boy's Haircut": "Տղայի Կտրվածք",
    "2 Braids From The Roots": "Արմատներից 2 Հյուսք",
    "2 Braids with Threads": "Արմատներից 2 Հյուսք Թելերով ",
    "2 Braids With Kanekalon": "Արմատներից 2 Հյուսք Կանիկալոնով",
    "Short / Long Braid From Root (Per Braid)": "Արմատից Կարճ / Երկար Հյուսք (1 Հատ)",
    "Short / Long Braid With Thread (Per Braid)": "Արմատից Կարճ / Երկար Հյուսք Թելով (1 Հատ)",
    "African Braids (Per Braid)": "Աֆրիկյան Հյուսքեր (1 Հատ)",
    "Boy's Hair Styling": "Տղայի Մազերի Հարդարում",
    "Girl's Hair Styling": "Աղջկա Մազերի Հարդարում",
    "Ear Piercing": "Ականջի Դակում",
    "For Boys": "Տղաների",
    "Festive Hairstyle": "Տոնական Սանրվածք",
    "Kid’s Make-Up": "Մանկական MAKE UP",
    "The Waves": "Ալիքներ",
    ...
    "By discovering perfection, you will witness the invaluable work of our dedicated team.They will ensure your beautiful and well-groomed look.Whether you desire a luxurious manicure or a chic hairstyle,we guarantee a feeling of comfort throughout the entire experience.": "Բացահայտելով կատարելությունը՝ դու կտեսնես մեր նվիրված թիմի անգնահատելի աշխատանքը։ Նրանք կապահովեն քո գեղեցիկ և խնամված տեսքը։ Անկախ նրանից, թե դու շքեղ մատնահարդարում ես ցանկանում, թե Chic վարսահարդարում, այնուամենայնիվ մենք երաշխավորում ենք կոմֆորտի զգացողությունը ողջ աշխատանքի ընթացքում։",
    ...
    "Extension Removal": "Լիցքի Հեռացում",
    "Feet Acupressure": "Կետային Մերսում",
    "Eyebrow Shaping": "Հոնքերի շտկում",
    "Lamination": "Հոնքերի Լամինացիա",
    "Waxing": "Ոսկային Մազահեռացում",
    "Simply fill in the necessary information to secure your appointment with us. From preferred service to date and time, your nail care needs are in good hands.": "Պարզապես լրացրեք անհրաժեշտ տեղեկությունները՝ ամրագրելու ձեր հանդիպումը մեզ մոտ։ Նախընտրած ծառայությունից մինչև ամսաթիվ և ժամ, ձեր եղունգների խնամքի կարիքները վստահված են լավ ձեռքերով։",
    ...
    "Please enter your name": "Խնդրում ենք մուտքագրել ձեր անունը",
    "Please enter a valid phone number": "Խնդրում ենք մուտքագրել վավեր հեռախոսահամար",
    "Please select a master": "Խնդրում ենք ընտրել մասնագետ",
    "Please select at least one service": "Խնդրում ենք ընտրել առնվազն մեկ ծառայություն",
    ...
    "Lashes & Brows": "Թարթիչներ և Հոնքեր",
    "Hairstyling": "Վարսահարդարում",
    "Haircut": "Կտրրվածք",
    "Blow Dry Styling": "Հարդարում ֆենով",
    "Hot Tool Styling": "Հարդարում տաք գործիքով",
    "Evening Hairstyle": "Երեկոյան սանրվածք",
    "Root Coloring": "Արմատի ներկում",
    "Full Hair Coloring": "Միատոն ներկում",
    "Toning": "Տոնավորում",
    "Hair Lightening": "Գունաբացում",
    "Hair Treatment": "Խնամք",
    "Eyelash Extension 1D": "Թարթիչների լիցք 1D",
    "Eyelash Extension 2D": "Թարթիչների լիցք 2D",
    "Eyelash Extension 3D": "Թարթիչների լիցք 3D",
    "Eyelash Corners (Outer Corners Only)": "Թարթիչների անկյունային լիցք",
    "Shine / Kim Style Effect": "Շողեր / Քիմ ոճի էֆեկտ",
    "Wet Lash Effect": "Թաց էֆեկտ",
    "Eyelash Removal": "Աշխատանքի հեռացում",
    "Brow Styling": "Հոնքերի հարդարում",
    "Brow Shaping": "Հոնքերի շտկում",
    "Brow Tinting": "Հոնքերի ներկում",
    "Brow Lamination": "Հոնքերի լամինացիա",
