export const translationEN = {
    ...
    "Gel Lac + Manicure": "Gel Lac + Manicure",
    "Manicure + Simple Nail Polish": "Manicure + Simple Nail Polish",
    "Removing The Charge": "Removing The Charge",
    "Gel Removal": "Gel Removal",
    "Repair Of One Nail": "Repair Of One Nail",
    "Padding For One Nail": "Padding For One Nail",
    "Hand Acupressure": "Hand Acupressure",
    "Paraffin Therapy For Hands": "Paraffin Therapy For Hands",
    "Pedicure + Simple Nail Polish": "Pedicure + Simple Nail Polish",
    "Pedicure + Gel Lac": "Pedicure + Gel Lac",
    "Paraffin Therapy For Feet": "Paraffin Therapy For Feet",
    ...
    "Men's Pedicure (Without Heel Treatment)": "Men's Pedicure (Without Heel Treatment)",
    "Men's Paraffin Therapy For Hands": "Men's Paraffin Therapy For Hands",
    "Men's Paraffin Therapy For Feet": "Men's Paraffin Therapy For Feet",
    "Design": "Design",
